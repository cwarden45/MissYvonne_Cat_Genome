#setwd("E:\\Bastu_Genome\\MissYvonne_Cat_Genome")

input_folder = "BWA-MEM_Human-hg19_Cat-felCat9-Bacteria11Virus10_Alignment"
input_reference_counts = "Kraken2/Oral3_FILTERED_Braken_genera-counts.txt"
Cat   = c("MissYvonne", "Bastu", "Bastu")
SampleSite= c("Oral","Oral","Oral")
output.percent_quantified = "n3_Oral_BWA-MEM-heatmap_quantified.txt"
output.counts = "n3_Oral_BWA-MEM-counts_raw.txt"
output.percent = "n3_Oral_BWA-MEM-percent-external_normalized.txt"
heatmap.output = "n3_Oral_BWA-MEM-heatmap.pdf"
