...
my $input_ped = "Gandolfi_felCat8_plus_MissYvonne.ped";
my $output_pop = "Gandolfi_felCat8_plus_MissYvonne.pop";
my $mapping_file = "../../Cat_SNP_Chip/fromHasan/FID_breed_codes_fromHasan.txt";#if you want to change the mapping, you'll have to modify this code (and either over-write the other file, or save the files in another location)
